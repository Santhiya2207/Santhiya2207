...
Pavendar Bharathidasan College of Engineering and Technology, Anna University, Trichy, TN  
...
- Implemented secure Firebase-based user authentication and profile management system supporting seamless onboarding.
- Built a structured job application tracking workflow with real-time database updates and automated email notifications via EmailJS.
...
- Developed 2 interactive Tableau dashboards identifying downtime patterns across factories and device types.
- Created calculated fields in Tableau to visualize and classify operational performance metrics.
- Classified equality scores into 3 categories in Excel using conditional logic and formulas.
---
### 📊 Data Analysis Intern (Academic) | HITAKEY TECH SOLUTION PRIVATE LIMITED | Sep 2025 – Nov 2025 | Trichy, Tamil Nadu
- Performed data cleaning and preprocessing on academic datasets using Excel and Python.
- Applied Excel functions (VLOOKUP, IF, sorting, filtering) to organize and process structured data.
